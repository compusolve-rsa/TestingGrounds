...
| `Green barrier dividing Tiles. Player can move through it to next Tile. When moving to next Tile, generating post following Tile with random generating meshes at correct locations do not intersect each other.` ![green barrier dividing tiles](https://user-images.githubusercontent.com/28482025/51083723-4be2a080-1740-11e9-8eaa-1e6a349f1592.png) | `Red barrier dividing Tiles. Player can not move through it to the past Tile. Player can move only to forward Tile.` ![red barrier dividing tiles player can not move through it](https://user-images.githubusercontent.com/28482025/51083728-759bc780-1740-11e9-9152-021def0f9af3.png) |
